...
if ( get_theme_mod( 'my_colors_site_accent' ) ) {
	/* ピックアップ */
	echo esc_attr( '.header-nav li.m-pickup a{background:' . get_theme_mod( 'my_colors_site_accent' ) . ';}' );
